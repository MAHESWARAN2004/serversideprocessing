...
#### Addition before equal:

![Addition_Operation](./image/cal1.png)
...
A website to perform mathematical calculations in server side is designed and performed correctly.
